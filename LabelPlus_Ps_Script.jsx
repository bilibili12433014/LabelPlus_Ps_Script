"use strict";
var ColorSetting = "000";
// 颜色设置功能，由 明媚的山岚 添加
// Copyright 2023, https://github.com/bilibili12433014
// https://github.com/bilibili12433014/LabelPlus_Ps_Script
// 开源并遵循 GPL License
// License: https://github.com/bilibili12433014/LabelPlus_Ps_Script/blob/main/LICENSE
// 缺点：无界面，只能修改代码
// 求大佬搞一个界面
// 黑色：0,0,0 或 000000 或 000
// 白色：255,255,255 或 ffffff 或 fff
// 使用方法：将ColorSetting变量设置成相应的颜色对应的字符串
// 具体操作：修改var ColorSetting = 后面的引号内的内容
// 目前支持的颜色格式如下：
// r,g,b  ==>  0,127,255  ==>
// var ColorSetting = "0,127,255";
...
//
// $Id: GenericUI.jsx,v 1.173 2015/06/03 16:30:14 anonymous Exp $
...
var i18n;
(function (i18n) {
    i18n.APPNAME = "LabelPlus Script";
    i18n.TIP_TITLE = "说明";
    i18n.TIP_TEXT = "本脚本支持将LabelPlus格式的文本导入成ps图层。\r\n" +
    ...
    i18n.LABEL_TIP_FILE = "> 文件 / 预处理";
    i18n.LABEL_TIP_Behavior = "> 脚本行为";
    i18n.LABEL_TIP_STYLE_AUTO = "> 格式 / 自动化";
    i18n.LABEL_TEXTFILE = "LabelPlus文本:";
    i18n.LABEL_SOURCE = "图源文件夹:";
    i18n.LABEL_TARGET = "输出PSD文件夹:";
    i18n.LABEL_SETTING = "存取配置";
    i18n.LABEL_SELECTIMAGE = "导入图片选择";
    i18n.LABEL_SELECTGROUP = "导入分组选择";
    i18n.CHECKBOX_OUTPUTLABELNUMBER = "导出标号";
    i18n.CHECKBOX_TextReplace = "文本替换(格式:\"A->B|C->D\")";
    i18n.CHECKBOX_OUTPUTNOSIGNPSD = "导出没有标号的文档";
    i18n.CHECKBOX_AutoMatchImgFile = "按顺序自动匹配图片文件";
    i18n.BUTTON_AutoMatchImgFilePreview = "预览匹配结果";
    i18n.CHECKBOX_SetSourceType = "替换图片后缀名";
    i18n.CHECKBOX_RUNACTION = "导入文本后，执行以分组名命名的动作；打开图片时执行_start，关闭前执行_end动作";
    i18n.CHECKBOX_NOTCLOSE = "导入后不关闭文档";
    i18n.CHECKBOX_SetFont = "字体";
    i18n.CHECKBOX_SetLeading = "行距";
    i18n.CHECKBOX_OutputHorizontalText = "输出横向文本";
    i18n.CHECKBOX_LAYERNOTGROUP = "不对图层进行分组";
    i18n.CHECKBOX_OVERLAY = "对指定分组执行涂白动作(实验性功能)";
    i18n.COMPLETE = "导出完毕！";
    i18n.ERROR_NOTFOUNDSOURCE = "未找到图源文件夹";
    i18n.ERROR_NOTFOUNDTARGET = "未找到目标文件夹";
    i18n.ERROR_NOTFOUNLABELTEXT = "未找到LabelPlus文本文件";
    i18n.ERROR_CANNOTBUILDNEWFOLDER = "无法创建新文件夹";
    i18n.ERROR_READLABELTEXTFILEFAILL = "解析LabelPlus文本失败";
    i18n.ERROR_NOTCHOOSEIMAGE = "未选择输出图片";
    i18n.ERROR_NOTCHOOSEGROUP = "未选择导入分组";
    // if (true) {
    if (!(app.locale in { "zh_CN": 1, "zh_TW": 1, "zh_HK": 1 })) {
        i18n.TIP_TITLE = "Note";
        i18n.TIP_TEXT = "Help: https://noodlefighter.com/label_plus/";
        i18n.BUTTON_RUN = "Run";
        i18n.BUTTON_CANCEL = "Cancel";
        i18n.BUTTON_LOAD = "Load";
        i18n.BUTTON_SAVE = "Save";
        i18n.BUTTON_RESET = "Reset";
        i18n.LABEL_TIP_FILE = "> File / Preprocessing";
        i18n.LABEL_TIP_Behavior = "> Behavior";
        i18n.LABEL_TIP_STYLE_AUTO = "> Format / Automation";
        i18n.LABEL_TEXTFILE = "LabelPlus Text:";
        i18n.LABEL_SOURCE = "Image Source:";
        i18n.LABEL_TARGET = "Output PSD:";
        i18n.LABEL_SETTING = "Setting";
        i18n.LABEL_SELECTIMAGE = "Select Image";
        i18n.LABEL_SELECTGROUP = "Select Group";
        i18n.CHECKBOX_OUTPUTLABELNUMBER = "Output Label Number";
        i18n.CHECKBOX_TextReplace = "Text Replace(e.g. \"A->B|C->D\")";
        i18n.CHECKBOX_OUTPUTNOSIGNPSD = "Output no label file";
        i18n.CHECKBOX_AutoMatchImgFile = "Auto Match Imgage Source File";
        i18n.BUTTON_AutoMatchImgFilePreview = "Preview Match Result";
        i18n.CHECKBOX_SetSourceType = "Replace file extension";
        i18n.CHECKBOX_RUNACTION = "Execute actions named of group name;\"_start\" after open, \"_end\" before close";
        i18n.CHECKBOX_NOTCLOSE = "Do not close the file";
        i18n.CHECKBOX_SetFont = "Set default font";
        i18n.CHECKBOX_SetLeading = "Set leading size";
        i18n.CHECKBOX_OutputHorizontalText = "Output horizontal text";
        i18n.CHECKBOX_LAYERNOTGROUP = "Layer not grouping";
        i18n.CHECKBOX_OVERLAY = "Execute \"Text Overlay\" on specified group";
        i18n.COMPLETE = "Export completed!";
        i18n.ERROR_NOTFOUNDSOURCE = "Image Source Folder Not Found!";
        i18n.ERROR_NOTFOUNDTARGET = "Output PSD Folder Not Found!";
        i18n.ERROR_NOTFOUNLABELTEXT = "LabelPlus Text File Not Found!";
        i18n.ERROR_CANNOTBUILDNEWFOLDER = "Could not build new folder";
        i18n.ERROR_READLABELTEXTFILEFAILL = "Fail To Load LabelPlus Text File";
        i18n.ERROR_NOTCHOOSEIMAGE = "Please select more than one image";
        i18n.ERROR_NOTCHOOSEGROUP = "Please select more than one group";
    }
})(i18n || (i18n = {}));
...
// 初始设置
//
var LabelPlusInputOptions = /** @class */ (function () {
    function LabelPlusInputOptions(obj) {
        this.setTextLeading = true; // 是否设置行距
        this.outputNoSignPsd = true; // 输出未标号的图片，默认为真
        var self = this;
        Stdlib.copyFromTo(obj, self);
    }
    return LabelPlusInputOptions;
}());
;
//
// 用户UI
...
LabelPlusInput.prototype.createPanel = function (pnl, ini) {
    ...
    //------------------LabelPlus文件区------------------
    // LabelPlus文本文件输入
    pnl.lpTextFileLabel = pnl.add('statictext', [xx, yy, xx + 120, yy + 20], i18n.LABEL_TEXTFILE);
    xx += 120;
    ...
    pnl.lpTextFileBrowseButton.onClick = function () {
        try {
            var pnl_1 = this.parent;
            var fmask = "*.txt;*.json";
            var f = File.openDialog(i18n.LABEL_TEXTFILE, fmask);
            if (f && f.exists) {
                pnl_1.lpTextFileTextBox.text = f.toUIString();
                //图源、输出文件夹赋上目录
                var fl = new Folder(f.path);
                pnl_1.sourceTextBox.text = fl.toUIString();
                pnl_1.targetTextBox.text = fl.toUIString() + dirSeparator + 'output';
            }
            else {
                return; //取消
            }
            pnl_1.chooseImageListBox.removeAll();
            pnl_1.chooseGroupListBox.removeAll();
            // 读取LabelPlus文件
            var labelFile = void 0;
            try {
                labelFile = new LabelPlusTextReader(pnl_1.lpTextFileTextBox.text);
            }
            catch (err) {
                alert(err);
                return;
            ...
            // 填充图片选择列表
            var iarr = labelFile.ImageList;
            if (iarr) {
                for (var i = 0; i < iarr.length; i++) {
                    pnl_1.chooseImageListBox[i] = pnl_1.chooseImageListBox.add('item', iarr[i], i);
                    pnl_1.chooseImageListBox[i].selected = true;
                }
            }
            // 填充分组选择列表
            var garr = labelFile.GroupData;
            if (garr) {
                for (var i = 0; i < garr.length; i++) {
                    if (garr[i] == "")
                        continue;
                    pnl_1.chooseGroupListBox[i] = pnl_1.chooseGroupListBox.add('item', garr[i], i);
                    pnl_1.chooseGroupListBox[i].selected = true;
                    // 涂白 指定分组文本框若空 填第一个分组
                    if (pnl_1.overlayGroupTextBox.text == "") {
                        pnl_1.overlayGroupTextBox.text = garr[i];
                    }
                }
            }
            pnl_1.labelFile = labelFile; //返回LabelPlusTextReader对象
        }
        catch (e) {
            alert(Stdlib.exceptionMessage(e));
        }
    ...
    pnl.sourceBrowse.onClick = function () {
        try {
            var pnl_2 = this.parent;
            var def = (pnl_2.sourceTextBox.text ?
                new Folder(pnl_2.sourceTextBox.text) : Folder.desktop);
            var f = Folder.selectDialog(i18n.LABEL_SOURCE, def);
            if (f) {
                pnl_2.sourceTextBox.text = f.toUIString();
                if (!pnl_2.targetTextBox.text) {
                    pnl_2.targetTextBox.text = pnl_2.sourceTextBox.text;
                }
            }
        }
        catch (e) {
    ...
    pnl.targetBrowse.onClick = function () {
        try {
            var pnl_3 = this.parent;
            var f = void 0;
            var def = pnl_3.targetTextBox.text;
            if (!def) {
                if (pnl_3.sourceTextBox.text) {
                    def = pnl_3.sourceTextBox.text;
                }
                else {
                    def = Folder.desktop;
                }
            ...
            if (f) {
                pnl_3.targetTextBox.text = f.toUIString();
            }
        }
        catch (e) {
            alert(Stdlib.exceptionMessage(e));
    ...
    pnl.ignoreImgFileNameTestButton.onClick = function () {
        var originFileNameList = getFilesListOfPath(pnl.sourceTextBox.text);
        var selectedImgFileNameList = getSelectedItemsText(pnl.chooseImageListBox);
    ...
    pnl.setSourceFileTypeList = pnl.add('dropdownlist', [xx, yy, xx + 70, yy + 22], setSourceFileTypeListItems);
    ...
    yy += 25;
    // 自定义行距
    pnl.setTextLeadingCheckBox = pnl.add('checkbox', [xx, yy, xx + 125, yy + 20], i18n.CHECKBOX_SetLeading);
    ...
    yy += 20;
    // 执行动作GroupN
    pnl.runActionGroupCheckBox = pnl.add('checkbox', [xx, yy, xx + 500, yy + 22], i18n.CHECKBOX_RUNACTION);
...
// 自定义读取配框
//
var createSettingsPanel = function (pnl, ini) {
    ...
    pnl.save.onClick = function () {
        ...
        if (f) {
            var mgr_1 = win.mgr;
            var res = mgr_1.validatePanel(win.appPnl, win.ini, true);
            if (typeof (res) != 'boolean') {
                writeIni(f, res);
                if (pnl.onSave) {
                    pnl.onSave(f);
...
LabelPlusInput.prototype.process = function (opts, doc) {
    ...
    //读取图源文件夹文件列表
    var originFileList = getFilesListOfPath(opts.source);
    //解析LabelPlus文本
    ...
    for (var i = 0; i < opts.imageSelected.length; i++) {
        ...
        for (var j = 0; j < labelData.length; j++) {
            ...
            // 导出标号
            if (opts.outputLabelNumber) {
                newTextLayer(bg, String(labelNum), labelX, labelY, "Arial", opts.setFont ? opts.fontSize : undefined, false, 90, layerGroups["_Label"], 0);
            }
            // 替换文本
            if (textReplace) {
            ...
            if (labelString && labelString != "") {
                artLayer = newTextLayer(bg, labelString, labelX, labelY, opts.setFont ? opts.font : "SimSun", opts.setFont ? opts.fontSize : undefined, !opts.horizontalText, 90, opts.layerNotGroup ? undefined : layerGroups[labelGroup], opts.textLeading ? parseFloat(opts.textLeading) : 0);
                var cleanedSetting = ColorSetting.replace(/[^a-zA-Z0-9, ]/g, '');
                var r, g, b;
                if (cleanedSetting.indexOf(',') !== -1) {
                    var splitColors = cleanedSetting.split(',');
                    r = parseInt(splitColors[0], 10);
                    g = parseInt(splitColors[1], 10);
                    b = parseInt(splitColors[2], 10);
                } else if (cleanedSetting.indexOf(' ') !== -1) {
                    var splitColors = cleanedSetting.split(' ');
                    r = parseInt(splitColors[0], 10);
                    g = parseInt(splitColors[1], 10);
                    b = parseInt(splitColors[2], 10);
                } else {
                    if (cleanedSetting.length === 3) {
                        cleanedSetting = cleanedSetting[0] + cleanedSetting[0] + cleanedSetting[1] + cleanedSetting[1] + cleanedSetting[2] + cleanedSetting[2];
                    }
                    r = parseInt(cleanedSetting.substr(0, 2), 16);
                    g = parseInt(cleanedSetting.substr(2, 2), 16);
                    b = parseInt(cleanedSetting.substr(4, 2), 16);
                }
                artLayer.textItem.color.rgb.red = r;
                artLayer.textItem.color.rgb.green = g;
                artLayer.textItem.color.rgb.blue = b;
            }
            // 执行动作,名称为分组名
            if (opts.runActionGroup) {
                try {
...
// 创建文本图层
//
var newTextLayer = function (doc, text, x, y, font, size, isVertical, opacity, group, lending) {
...
// 文本替换字符串解析程序
//
var textReplaceReader = function (str) {
    var arr = new Array();
    var strs = str.split('|');
    if (!strs)
        return; //解析失败
...
var writeIni = function (iniFile, ini) {
    //$.level = 1; debugger;
    if (!ini || !iniFile) {
        return;
    }
...
// 读出配置
//
var readIni = function (iniFile, ini) {
    //$.level = 1; debugger;
    if (!ini) {
...
// 获取文件夹下文件的文件名字符串列表
//
var getFilesListOfPath = function (path) {
...
//
var getSelectedItemsText = function (listBox) {
